...
public class MainActivity extends AppCompatActivity implements WeatherSourceCallback,EasyPermissions.PermissionCallbacks {
    ...
    public boolean isNetworkAvailable() {
        ...
        if (manager != null) {
            Log.i("getActiveNetworkInfo()", "is not null");
            networkInfo = manager.getActiveNetworkInfo();
        } else {
            Log.e("getActiveNetworkInfo()", "is null");
        }
    ...
    /**
     * On this method there is defined which permissions this application needs, so the request execution start from here;
     */
